  ...
  return (
    <ThemedView className="!justify-start">
      ...
      <ThemedView className="!justify-start !items-start mt-[10%] w-full pl-10">
        ...
        <ThemedText className="!text-[#AACC00] text-[24px] sm:text-[32px] text-wrap max-w-[70%] font-bold">
      ...
      <ThemedView className="flex-row w-full max-h-[10%] gap-10 mb-10 !items-start">
        <ThemedButton mode="normal" onPress={() => router.push('/SignIn')}>Sign In</ThemedButton>
        <ThemedButton mode="confirm" onPress={() => router.push('/SignUp')}>Sign Up</ThemedButton>
      </ThemedView>
    </ThemedView>
  );
}
