  ...
  return (
    ...
    <ThemedView className="w-full h-full flex-1 ">
      <ThemedScrollView>
        ...
        <ThemedView className={`${theme==="dark" ?"bg-[#000000]" : "bg-[#ffffff]"} bottom-20 px-10 w-full bg-transparent`}>
          <ThemedButton className="mt-3 px-10 w-full  h-12 bg-green-500">Add Transaction</ThemedButton>
        </ThemedView>
    </ThemedView>
    </ThemedSafeAreaView>
