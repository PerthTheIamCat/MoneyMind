...
router.post("/create", jwtValidate, (req, res) => {
  const { user_id, notification_type, color_type, message } = req.body;
  ...
  db.query(
    ...
    (err, result) => {
      if (err) {
        console.log(
          "Error from /create from INSERT INTO notifications (user_id, notification_type, color_type, message) VALUES (?, ?, ?, ?)"
        );
      ...
      return res
        .status(201)
        .json({ result, message: "Notification Created", success: true });
    }
  );
});
...
router.get("/new/:id", jwtValidate, (req, res) => {
  ...
  db.query(
    ...
    (err, result) => {
      ...
      if (err) {
        console.log(
          "Error from .get/:id from SELECT * FROM notifications WHERE user_id = ? ORDER BY created_at DESC"
        );
        console.log("Database query failed");
        console.log("Error:", err);
        return res
      ...
      return res
        .status(200)
        .json({ result, message: "Get Notification", success: true });
    }
  );
});
...
router.get("/:id", jwtValidate, (req, res) => {
  ...
  db.query(
    ...
    (err, result) => {
      ...
      if (err) {
        console.log(
          "Error from .get/:id from SELECT * FROM notifications WHERE user_id = ?"
        );
        console.log("Database query failed");
        console.log("Error:", err);
        return res
...
router.put("/:id", jwtValidate, (req, res) => {
  ...
  db.query(
    ...
    (err, result) => {
      ...
      if (err) {
        console.log(
          "Error from .put/:id from UPDATE notifications SET ? WHERE id = ?"
        );
        console.log("Database query failed");
        console.log("Error:", err);
        return res
      ...
      if (result.length === 0) {
        ...
        return res
          .status(404)
          .json({ message: "Nofitication not found", success: false });
      }

      console.log("Notification updated");
      return res
        .status(200)
        .json({ message: "Nofitication updated", success: true });
    }
  );
});
...
router.delete("/:id", jwtValidate, (req, res) => {
  ...
  db.query(
    ...
    (err, result) => {
      ...
      if (err) {
        console.log(
          "Error from .delete/:id from DELETE FROM notifications WHERE id = ?"
        );
        console.log("Database query failed");
        console.log("Error:", err);
        return res
